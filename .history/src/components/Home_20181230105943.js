  ...
  render() {
    return (
      <div className="main-content home">
        <h2>Learn based on real market needs</h2>
        <p>In IT, experience is everything. Employers want developers capable of taking on projects and solving problems, things that only real experience can teach you. That’s why the 100+ hours in class are heavily practical. Together with a senior practitioner, our groups become teams who work on real projects, just like in a company. Theory is studied independently via our web portal.</p>
        <p>For this to work, our close ties with Beetroot are key. They continuously provide us with their recent projects, so that the skills you learn are top-modern and hot on the market.</p>
        ...
        <Link to="/teacher/Bill">Bill geitz</Link>
      </div>
    );
  }
}
