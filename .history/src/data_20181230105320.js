export const frontEnd =  [
        ...
        },
        {
            id: 2,
            title: "CSS Selectors",
            description: "n CSS, selectors are used to target the HTML elements on our web pages that we want to style. There are a wide variety of CSS selectors available, allowing for fine grained precision when selecting elements to style.",
            im:"/i/css_selectors.jpg"
        },
        {
            id: 3,
            title: "Responsive Layouts",
            description: "Responsive web design (RWD) is an approach to web design which makes web pages render well on a variety of devices and window or screen sizes. Recent work also considers the viewer proximity as part of the viewing context as an extension for RWD",
            im: "/i/responsive.jpg"
        ...
        },
        {
            ...
            im: "/i/flexbox_css.jpg"
        },
        {
            id:5,
            title: "CSS Grid Layout",
            description: "CSS grid layout or CSS grid is a technique in CSS that allows web developers to create complex responsive web design layouts more easily and consistently",
            im: "/i/grid.jpg"
        }
    ];
 ...
 export const  htmlCourses =  [
        {
            id: 6,
            title: "HTML Basic",
            description: "Hypertext Markup Language (HTML) is the standard markup language for creating web pages and web applications. With Cascading Style Sheets (CSS) and JavaScript, it forms a triad of cornerstone technologies for the World Wide Web.[3] Web browsers receive HTML documents from a web server or from local storage and render them into multimedia web pages. ",
            im: "/i/html_basic.jpg"
...
export const javaScriptCourses =  [
        {
            id: 10,
